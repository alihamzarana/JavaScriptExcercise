...
// a list of mountains, rivers, countries, cities, languages, or 
// anything else you’d like. Write a program that creates a list containing these items.

const rivers = ['Sindh', 'Ravi', 'Neel'];
const languages = ['Punjabi', 'Urdu', 'English'];
const cities = ['Islamabad', 'Lahore', 'Karachi'];
const countries = ['Pakistan', 'Russia', 'China'];
const mountains = ['K2', 'Nanga Parbat', 'Raka Poshi'];
